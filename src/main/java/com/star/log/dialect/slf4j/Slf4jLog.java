package com.star.log.dialect.slf4j;
...
public class Slf4jLog extends AbstractLocationAwareLog {
    ...
    public void trace(String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.TRACE_INT, format, arguments)) {
    ...
    public void trace(Throwable t, String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.TRACE_INT, t, format, arguments)) {
    ...
    public void debug(String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.DEBUG_INT, format, arguments)) {
    ...
    public void debug(Throwable t, String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.DEBUG_INT, t, format, arguments)) {
    ...
    public void info(String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.INFO_INT, format, arguments)) {
    ...
    public void info(Throwable t, String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.INFO_INT, t, format, arguments)) {
    ...
    public void warn(String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.WARN_INT, format, arguments)) {
    ...
    public void warn(Throwable t, String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.WARN_INT, t, format, arguments)) {
    ...
    public void error(String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.ERROR_INT, format, arguments)) {
    ...
    public void error(Throwable t, String format, Object... arguments) {
        if (!locationAwareLog(LocationAwareLogger.ERROR_INT, t, format, arguments)) {
...
//			((LocationAwareLogger)this.logger).log(null, fqcn, level_int, msgTemplate, arguments, t);
            ...
            ((LocationAwareLogger) this.logger).log(null, fqcn, level_int, StringUtil.format(msgTemplate, arguments), null, t);
            return true;
        } else {
            return false;
        }
