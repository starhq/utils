package com.star.log.dialect.log4j2;
...
public class Log4j2Log extends AbstractLocationAwareLog {
    ...
    public void trace(Throwable t, String format, Object... arguments) {
        if (!logIfEnabled(Level.TRACE, t, format, arguments)) {
    ...
    public void debug(Throwable t, String format, Object... arguments) {
        if (!logIfEnabled(Level.DEBUG, t, format, arguments)) {
    ...
    public void info(Throwable t, String format, Object... arguments) {
        if (!logIfEnabled(Level.INFO, t, format, arguments)) {
    ...
    public void warn(Throwable t, String format, Object... arguments) {
        if (!logIfEnabled(Level.WARN, t, format, arguments)) {
    ...
    public void error(Throwable t, String format, Object... arguments) {
        if (!logIfEnabled(Level.ERROR, t, format, arguments)) {
            logger.warn(StringUtil.format(format, arguments), t);
        }
    }
