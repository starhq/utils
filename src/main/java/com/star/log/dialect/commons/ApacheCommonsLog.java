...
public class ApacheCommonsLog extends AbstractLog {
    ...
    public void trace(String format, Object... arguments) {
        if (isTraceEnabled()) {
            logger.trace(StringUtil.format(format, arguments));
        }
    }
    ...
    public void debug(String format, Object... arguments) {
        if (isDebugEnabled()) {
            logger.debug(StringUtil.format(format, arguments));
        }
    }
    ...
    public void info(String format, Object... arguments) {
        if (isInfoEnabled()) {
            logger.info(StringUtil.format(format, arguments));
        }
    }
    ...
    public void error(String format, Object... arguments) {
        if (isErrorEnabled()) {
            logger.error(StringUtil.format(format, arguments));
        }
    }
