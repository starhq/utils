...
import com.star.log.AbstractLog;
...
public class TinyLog extends AbstractLog {
    ...
    private static Throwable getLastArgumentIfThrowable(Object... arguments) {
        if (!ArrayUtil.isEmpty(arguments) && arguments[arguments.length - 1] instanceof Throwable) {
    ...
    public void trace(String format, Object... arguments) {
        log(com.star.log.level.Level.TRACE, format, arguments);
    }

    @Override
    public void trace(Throwable t, String format, Object... arguments) {
        log(com.star.log.level.Level.TRACE, t, format, arguments);
    }
    ...
    public void debug(String format, Object... arguments) {
        log(com.star.log.level.Level.DEBUG, format, arguments);
    }

    @Override
    public void debug(Throwable t, String format, Object... arguments) {
        log(com.star.log.level.Level.DEBUG, t, format, arguments);
    }
    ...
    public void info(String format, Object... arguments) {
        log(com.star.log.level.Level.INFO, format, arguments);
    }

    @Override
    public void info(Throwable t, String format, Object... arguments) {
        log(com.star.log.level.Level.INFO, t, format, arguments);
    }
    ...
    public void warn(String format, Object... arguments) {
        log(com.star.log.level.Level.WARN, format, arguments);
    }

    @Override
    public void warn(Throwable t, String format, Object... arguments) {
        log(com.star.log.level.Level.WARN, t, format, arguments);
    }
    ...
    public void error(String format, Object... arguments) {
        log(com.star.log.level.Level.ERROR, format, arguments);
    }

    @Override
    public void error(Throwable t, String format, Object... arguments) {
        log(com.star.log.level.Level.ERROR, t, format, arguments);
    }
     ...
     * @since 4.0.3
     */
    private Level toTinyLevel(com.star.log.level.Level level) {
        Level tinyLevel;
        switch (level) {
            case TRACE:
