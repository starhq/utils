...
public class Log4jLog extends AbstractLocationAwareLog {
    ...
    public void trace(Throwable t, String format, Object... arguments) {
        logger.log(FQCN, Level.TRACE, StringUtil.format(format, arguments), t);
    }
    ...
    public void debug(Throwable t, String format, Object... arguments) {
        logger.log(FQCN, Level.DEBUG, StringUtil.format(format, arguments), t);
    }
    ...
    public void info(Throwable t, String format, Object... arguments) {
        logger.log(FQCN, Level.INFO, StringUtil.format(format, arguments), t);
    }
    ...
    public void warn(Throwable t, String format, Object... arguments) {
        logger.log(FQCN, Level.WARN, StringUtil.format(format, arguments), t);
    }
    ...
    public void error(Throwable t, String format, Object... arguments) {
        logger.log(FQCN, Level.ERROR, StringUtil.format(format, arguments), t);
    }
